<%-- 
    Document   : AdminLogin
    Created on : Mar 1, 2023, 9:43:15 AM
    Author     : GG
--%>
                                ...
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5 mx-md-4">
                                        <div class="text-center">
                                            ...
                                            <h4 class="mt-1 mb-5 pb-1">Admin Tech Shop</h4>
                                        </div>
                                        <form action="loginAdmin" method="post">
                                            ...
                                            <div class="form-outline mb-4">
                                                ...
                                                <input type="password" name="phone" id="form2Example22" class="form-control"  placeholder="Password" />
                                            </div>
