<%-- 
    Document   : AdminUpdateStocks
    Created on : Mar 4, 2023, 11:23:57 PM
    Author     : GG
--%>
...
<html>
    ...
    <body>
        <%
            ...
            ResultSet sto = (ResultSet)request.getAttribute("list");
                ...
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5">
                        ...
                        <form action="AdminStocks" method="post"> 
                            <input  type="hidden" value="updateStock" name="service">
                            <%if (sto.next()) {%>
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <select name="store_id" id="store_id">
                                        <%while(rsStore.next()) {%>
                                        <option value="<%=rsStore.getInt(1)%>" <%=(rsStore.getInt(1) == sto.getInt(1) ? "selected" : "")%> > <%=rsStore.getString(2)%> </option>
                                        <%}%>
                                    </select>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <select name="product_id" id="product_id">
                                        ...
                                        <option value="<%=rsProduct.getInt(1)%>" <%=(rsProduct.getInt(1) == sto.getInt(2) ? "selected" : "")%>><%=rsProduct.getString(2)%></option>
                                        <%}%>
                                    </select>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="number" name="quantity" id="quantity" value="<%=sto.getInt(3)%>">
                                </div>
