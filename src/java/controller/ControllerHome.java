    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("displayAll")) {
                ...
                Vector<Stores> listStore = dao1.listAll();
                Vector<Products> topproduct = dao.listTopProduct();
                Vector<Products> lopproduct = dao.listTopProduct1();
                session.setAttribute("listStore", listStore);
                request.setAttribute("topproduct", topproduct);
                request.setAttribute("lopproduct", lopproduct);
