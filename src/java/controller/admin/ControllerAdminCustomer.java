    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(service.equals("displayAll")){
               Vector<Customer> list = dao.listAll();
                request.setAttribute("list", list);
                request.getRequestDispatcher("/admin/DisplayCustomer.jsp").forward(request, response);
           }
           if(service.equals("searchCustomerName")){
               String name = request.getParameter("name");
               Vector<Customer> list = dao.searchLname(name);
               request.setAttribute("list", list);
                request.getRequestDispatcher("/admin/DisplayCustomer.jsp").forward(request, response);
           }
